/* STEP 1: Number types (integer, float, and double)
        ...
        /* what is preincrement, postincrement, predecrement, postdecrement 
        preincrement- increments then returns the new value
        postincrement return the current value then increments
        predecrement decremetns and then returns the new value
        postdrecerment return the current value and then decrement */
